...
import DocumentHolderForm from './DocumentHolderForm'

class DocumentHolderApp extends Component {
  ...
  async loadBlockchainData() {
    ...
    if(networkData) {
	  ...
	  const documentHoldersSize = await documentIdentifier.methods.documentHoldersSize().call()
      this.setState({ documentHoldersSize })
      // Load products
...
export default DocumentHolderApp;